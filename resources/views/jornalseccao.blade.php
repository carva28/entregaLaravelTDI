    ...
    <nav class="navbar_jornal_news navbar navbar-expand-lg ">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                @if($secjornal->seccao_id == $seccaoatual)
                <a class="itemseccao nav-item nav-link" href="{{ url('lista_noticia_seccao/'.$seccao->id.'/'.$jornais->id) }}">{{$seccao->nome_seccao}}</a>
                @else
            ...
            <div id="cardSeccao" class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <p class="seccao_p">{{ $noticia->created_at }}</p>
                    ...
                    <div class="column">
                        ...
                        <div class="media">
                            <audio class="testeaudio-media-body media-body" controls>
