      ...
      <div class="card_edit_seccao card">
        ...
        <div class="card-body">
          <form method="POST" action="{{ route('update-conteudo', $conteudos->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <select name="tipo_conteudo">
                  ...
                  <option selected value="{{ $conteudos->tipo_conteudo }}" select> {{ $conteudos->tipo_conteudo }}
                  </option>
            ...
            <div class="form-group row">
              @if(pathinfo($conteudos->ficheiro_conteudo, PATHINFO_EXTENSION) == 'mpga' ||
              pathinfo($conteudos->ficheiro_conteudo, PATHINFO_EXTENSION) == 'mp3')
              <div class="col-md-6">
                <label for="ficheiro_conteudo"
                  class="label_file_content col-md-4 col-form-label text-md-right">File</label>
              </div>
              <div class="col-md">
                <audio controls>
                  <source src="/uploads/{{$conteudos->ficheiro_conteudo}}" type="audio/mpeg"> Your browser does not
                  support the audio tag.
                </audio>
                <input id="ficheiro_conteudo" type="file"
                  class="form-control @error('ficheiro_conteudo') is-invalid @enderror" name="ficheiro_conteudo"
                  value="{{ $conteudos->ficheiro_conteudo }}">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input id="user_id" type="text" class="invisible form-control @error('user_id') is-invalid @enderror"
                  name="user_id" value="{{ Auth::user()->id }}" required autocomplete="titulo_noticia" autofocus>
                @error('user_id')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <select name="noticia_id">
                  ...
                  <option selected value="{{ $conteudos->noticia_id }}"> {{ $conteudos->noticia->titulo_noticia }}
                  </option>
                  @else
            ...
            <div class="form_btn_group_edit_content form-group row mb-0">
              <div class="col-md-6 offset-md-4">
                ...
                <a href="{{ route('lista_conteudo') }}"
                  class="btn_eliminaSmall btncandelarseccao btn btn-xs btn-info pull-right">
                  Cancelar
                </a>
              </div>
            </div>
